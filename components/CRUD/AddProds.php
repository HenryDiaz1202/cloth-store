<div class="contenedor-main"> 
    ...
    <form class="form"  method="POST" action="CRUD/operaciones/GuardarProd.php">
        <label class="label-headers1" for="" id="register"><img src="../resources/add.png" width="45px"><spam class="span">↓</spam>  Registrando producto</label>
        <label class="label-headers1 label-over" for="" id="listar" onClick="listar()"> <img src="../resources/listado.png" width="45px"> Mostrar productos</label>
        ...
        <div class="grid">
            <!-- perteneciente a productos -->
             ...
             <input placeholder="Código de producto" class="inpt" type="text" name="idProd" value="" id="pr" required>
             <label class="label" for="">Nombre de producto</label>
             <input placeholder="Nombre de producto" class="inpt" type="text" name="producto" id="pr" required>
             <label class="label" for="">Marca</label>
             <input placeholder="Marca" class="inpt" type="text" name="marca" id="">
             <label class="label" for="">Descripción</label>
             <input placeholder="Descripción" class="inpt" type="text" name="descripsion" id="">
